...
ActiveRecord::Schema[8.1].define(version: 2026_05_19_072307) do
  ...
  create_table "artwork_locations", force: :cascade do |t|
    ...
    t.index ["artwork_id"], name: "index_artwork_locations_on_artwork_id"
  end
  ...
  create_table "artworks", force: :cascade do |t|
    ...
    t.index ["user_id", "is_public"], name: "index_artworks_on_user_id_and_is_public"
  ...
  create_table "studio_notes", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.date "written_on"
    t.index ["artwork_id"], name: "index_studio_notes_on_artwork_id"
  end
  ...
  add_foreign_key "artwork_locations", "artworks"
